    ...
    return (
        <div role='article'>
            <Table striped bordered hover size="sm">
                <thead>
                    <tr>
                        <th style={{ width: "15%" }} className='table-header-fixed-height'>Station Name</th>
                        <th style={{ width: "25%" }} className='table-header-fixed-height'>Address</th>
                        <th style={{ width: "5%" }} className='table-header-fixed-height'>Capacity</th>
                        <th style={{ width: "10%" }} className='table-header-fixed-height'>Journeys Start</th>
                        <th style={{ width: "10%" }} className='table-header-fixed-height'>End</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        ...
                        <th className='table-cell-fixed-height'>{station.Starting_station_count}</th>
                        <th className='table-cell-fixed-height'>{station.Ending_station_count}</th>
                    </tr>
                </tbody>
            </Table>
            ...
            <p className='centered-text'>
                latitude: {stationCoords.lat.toFixed(4)}, longitude: {stationCoords.lng.toFixed(4)}{' '}
            </p>
